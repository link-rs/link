...
pub fn erase_partitions<P: crate::connection::SerialInterface>(
    flasher: &mut Flasher<P>,
...
fn erase_partition<P: crate::connection::SerialInterface>(flasher: &mut Flasher<P>, part: &Partition) -> Result<()> {
